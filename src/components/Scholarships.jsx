...
const Scholarships = () => {
  ...
  return (
    <div className="w-full bg-[#2d2d2d] overflow-hidden">
      {/* For sm, md, lg – Stack layout */}
      <div className="xl:hidden flex flex-col w-full min-h-screen">
        {/* Image Top */}
        ...
        {/* Content Section */}
        <div className="bg-[#2d2d2d] flex-1 flex flex-col items-center justify-center text-center px-4 py-6 gap-4">
          <img
            src="https://landing.istitutomarangoni.com/images/logo_marangoni.svg"
            alt="Logo"
          ...
          <h2
            style={{ fontFamily: "Epika" }}
            className="bg-gradient-to-r from-[#d4af37] via-[#f5deb3] to-[#b8860b] bg-clip-text text-transparent text-2xl font-bold tracking-wide uppercase"
          >
            {slide.subheading}
          </h2>
          <p className="text-base font-medium text-white">{slide.text}</p>
      ...
      {/* For xl and up – Side Layout with animation */}
      <div
        key={current}
        className={`hidden xl:block relative w-full h-[80vh] overflow-hidden ${
          direction === "right" ? "animate-slide-right" : "animate-slide-left"
        }`}
      >
        {/* Clipped Image */}
        ...
        >
          <div className="max-w-md text-white text-center z-20">
            ...
            <h1
              style={{ fontFamily: "Epika" }}
              className="bg-gradient-to-r from-[#d4af37] via-[#f5deb3] to-[#b8860b] bg-clip-text text-transparent text-5xl font-bold mb-2 tracking-wide uppercase drop-shadow-lg"
            >
              {slide.heading}
            </h1>
            <h2
              style={{ fontFamily: "Epika" }}
              className="bg-gradient-to-r from-[#d4af37] via-[#f5deb3] to-[#b8860b] bg-clip-text text-transparent text-4xl font-bold mb-2 tracking-wide uppercase drop-shadow-lg"
            >
              {slide.subheading}
            </h2>
