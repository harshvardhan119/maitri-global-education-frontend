        ...
        <>
            <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-3xl flex flex-col items-center justify-center z-10 px-2">
                <div className='flex flex-col items-center gap-3'>
                   <h1
  className="bg-gradient-to-r from-[#d4af37] via-[#f5deb3] to-[#b8860b] bg-clip-text text-transparent font-cinzel text-2xl sm:text-3xl md:text-4xl leading-tight font-semibold tracking-wide text-center uppercase drop-shadow-lg"
>
  Turn Your Study Abroad Dreams into REALITY
</h1>

<h2
  className="w-full max-w-xl sm:text-lg md:text-2xl leading-tight font-normal text-center font-antic bg-gradient-to-r from-[#ffefbb] via-[#fddc99] to-[#e0c97d] bg-clip-text text-transparent drop-shadow-md"
>
